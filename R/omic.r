...
omic <- function(
  ...
  dopattern = TRUE, dovenn = TRUE, docluster = TRUE, nc = c(1,2,3,4,9,10,11,12), maxclusterheatmap = 5000,
  ...
  doena = TRUE, gsearank = "logfc",topdeg = 100 , topena = 60, doenaora = FALSE, gmtfiles = NULL, filtergeneset = NULL, bg = 25000,
